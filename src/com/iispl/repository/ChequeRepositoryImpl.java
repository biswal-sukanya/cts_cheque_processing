...
cheques.add(new Cheque("CHQ004", "Sneha Reddy", "Axis Bank", new BigDecimal("475000"), LocalDate.of(2026,7,6), LocalDate.of(2026,7,7), null, ChequeStatus.SENT_FOR_CLEARING));
...
cheques.add(new Cheque("CHQ006", "Priya Nair", "Union Bank", new BigDecimal("9500"), LocalDate.of(2026,7,8), LocalDate.of(2026,7,9), ChequePriority.LOW, null));
