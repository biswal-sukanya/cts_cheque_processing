...
cheques.add(new Cheque("CHQ001", "Nikhil Jain",null, new BigDecimal("28000"), LocalDate.of(2026,7,17), LocalDate.of(2026,7,18), ChequePriority.LOW, ChequeStatus.REJECTED));
		}
