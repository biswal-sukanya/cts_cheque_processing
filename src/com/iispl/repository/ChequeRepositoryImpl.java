...
public class ChequeRepositoryImpl implements ChequeRepository {
	...
	public List<Cheque> getAllCheques() {
		if(cheques.isEmpty()) {
cheques.add(new Cheque("CHQ015", "S Sharma", "SBI", new BigDecimal("215000"), LocalDate.of(2026,7,1), LocalDate.of(2026,7,2), ChequePriority.HIGH, ChequeStatus.ACCEPTED));
cheques.add(new Cheque("CHQ002", "Aisha Khan", "HDFC", new BigDecimal("225000"), LocalDate.of(2026,7,3), LocalDate.of(2026,7,4), ChequePriority.NORMAL, ChequeStatus.RECEIVED));
...
cheques.add(new Cheque("CHQ006", "Karan Mehta", "Karnataka Bank", new BigDecimal("60000"), LocalDate.of(2026,7,9), LocalDate.of(2026,7,10), ChequePriority.HIGH, ChequeStatus.VALIDATED));
...
cheques.add(new Cheque("CHQ004", "Kavya Rao", "South Indian Bank", new BigDecimal("16000"), LocalDate.of(2026,7,16), LocalDate.of(2026,7,17), ChequePriority.LOW, ChequeStatus.RECEIVED));
cheques.add(new Cheque("CHQ001", "Nikhil Jain", "UCO Bank", new BigDecimal("28000"), LocalDate.of(2026,7,17), LocalDate.of(2026,7,18), ChequePriority.LOW, ChequeStatus.REJECTED));
		}
