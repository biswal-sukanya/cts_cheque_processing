...
cheques.add(new Cheque("CHQ008", "Neha Singh", "Bank of Baroda",ClearingZone.MUMBAI, new BigDecimal("18000"), LocalDate.of(2026,7,10), LocalDate.of(2026,7,11), ChequePriority.NORMAL, ChequeStatus.VALIDATED));
