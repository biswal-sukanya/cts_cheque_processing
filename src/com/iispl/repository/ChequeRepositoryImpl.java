...
public class ChequeRepositoryImpl implements ChequeRepository {
	...
	public List<Cheque> chequeRecords() {
		if(cheques.isEmpty()) {
			cheques.add(new Cheque("CHQ001", "Rahul Sharma", "SBI", new BigDecimal("15000"), LocalDate.of(2026,7,1), LocalDate.of(2026,7,2), ChequePriority.HIGH, ChequeStatus.ACCEPTED));
			cheques.add(new Cheque("CHQ002", "Aisha Khan", "HDFC", new BigDecimal("25000"), LocalDate.of(2026,7,3), LocalDate.of(2026,7,4), ChequePriority.NORMAL, ChequeStatus.RECEIVED));
			...
			cheques.add(new Cheque("CHQ015", "Nikhil Jain", "UCO Bank", new BigDecimal("8000"), LocalDate.of(2026,7,17), LocalDate.of(2026,7,18), ChequePriority.LOW, ChequeStatus.REJECTED));
		}
